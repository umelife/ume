  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {/* Content */}
        <div className="bg-white rounded-lg shadow-md p-8 md:p-12 space-y-8 text-gray-700">
          <section>
          ...
          <section>
            ...
            <div className="space-y-4 leading-relaxed">
              <p>
                <strong className="text-gray-900">We do not sell your personal information.</strong> We only share your data in the following limited circumstances:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li><strong className="text-gray-900">With Other Users:</strong> Your display name and listings are visible to other verified students on the platform.</li>
                <li><strong className="text-gray-900">Service Providers:</strong> We use trusted third-party services (hosting, analytics, email) that help us operate the platform.</li>
                <li><strong className="text-gray-900">Legal Requirements:</strong> We may disclose information if required by law or to protect our rights and safety.</li>
                <li><strong className="text-gray-900">Business Transfers:</strong> In the event of a merger or acquisition, user data may be transferred to the new entity.</li>
              </ul>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 leading-relaxed ml-4">
              ...
              <li><strong className="text-gray-900">Correction:</strong> Update or correct your profile information at any time</li>
              <li><strong className="text-gray-900">Deletion:</strong> Request deletion of your account and associated data</li>
              <li><strong className="text-gray-900">Data Portability:</strong> Request your data in a machine-readable format</li>
          ...
          <section className="border-t border-gray-200 pt-8">
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <strong className="text-gray-900">Contact Form:</strong>{' '}
          ...
          <section className="bg-gray-50 p-6 rounded-lg mt-8">
            <p className="text-sm text-gray-600 leading-relaxed">
              <strong className="text-gray-900">Note:</strong> This is a sample privacy policy for the RECLAIM platform. For a production environment, this policy should be reviewed and customized by legal counsel to ensure compliance with applicable privacy laws (GDPR, CCPA, etc.) and your specific business practices.
            </p>
          </section>
        </div>
      </div>
